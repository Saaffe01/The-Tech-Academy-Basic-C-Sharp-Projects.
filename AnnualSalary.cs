...
class Program
{
    static void Main(string[] args)
    {
        ...
        // here we use data conversion. string to decimals
        ...
        // this shows the result of the output
        bool isP1Higher = p1Annual > p2Annual;
        Console.WriteLine("Does Person 1 make more money than Person 2?");
        Console.WriteLine(isP1Higher);
